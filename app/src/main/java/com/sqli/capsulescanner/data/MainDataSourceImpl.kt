            ...
            AppConstants.Processors.GOOGLE_VISION -> {
                ...
                try {
                    ...
                    return if (response.isSuccessful) {
                        ...
                        val jsonObject = ((JSONObject(responseContent).getJSONArray("responses").get(0) as JSONObject).getJSONObject("productSearchResults").getJSONArray("results").get(0) as JSONObject).getJSONObject("product").toString()
