...
class AppModule {
    ...
    @Singleton
    @Provides
    fun providesMainDataSource(apiService: ApiService, openAIApiService: OpenAIApiService): MainDataSource {
        return MainDataSourceImpl(apiService, openAIApiService)
    }
